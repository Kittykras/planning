            ...
            <tbody>
                ...
                foreach ($ctasks as $ctask) {
                    ...
                    <tr>
                        ...
                        <td><button class="btn btn-link btn-xs table-button" onclick="taskRedirect('<?php echo $ctask->t_id ?>', window.location.href)"><span style="color: <?php echo $ctask->t_state ?>">●</span> <?php echo $ctask->t_title ?> <span class="<?php echo $task->e_ikonplace ?>"></span></td>
